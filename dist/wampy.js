...
var Wampy = /*#__PURE__*/function () {
  ...
  _createClass(Wampy, [{
    ...
    value: function _hardClose(errorUri, details) {
      ...
      var err = new Errors.ProtocolViolationError(errorUri, details); // In case we were just making first connection
    ...
    value: function _wsOnOpen() {
      ...
      if (this._options.serializer.protocol !== serverProtocol) {
        ...
        if (serverProtocol === 'json') {
          ...
          var err = new Errors.NoSerializerAvailableError();
            ...
            switch (_context.prev = _context.next) {
              ...
              case 182:
                ...
                return this._calls[data[1]].onError(new Errors.CallError({
                  ...
                  details: data[2],
                  argsList: [_decodedPayload.err.message],
                  argsDict: null
                }));
                        ...
                        if (!_this3._checkPPTOptions('dealer', results.options)) {
                          if (_this3._cache.opStatus.error && _this3._cache.opStatus.error instanceof Errors.PPTNotSupportedError) {
                            ...
                            invoke_error_handler({
                              ...
                              argsList: [_this3._cache.opStatus.error.message],
                              argsDict: null
                            });
                          }
                  ...
                  if (results !== null && typeof results !== 'undefined') {
                    ...
                    if (res.err) {
                      invoke_error_handler({
                        details: results.options,
                        error: null,
                        // will be default'ed to invocation_exception
                        argsList: [_this3._cache.opStatus.error.message],
                        argsDict: null
                      });
                      return;
    ...
    value: function _wsOnError(error) {
      ...
      var err = new Errors.WebsocketError(error);
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 9:
                error = new Errors.InvalidParamError('match');
              ...
              case 14:
                ...
                _error2 = new Errors.InvalidParamError('advancedOptions');
              ...
              case 24:
                _error3 = new Errors.NoCallbackError();
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 20:
                ...
                _error4 = new Errors.InvalidParamError('advancedOptions');
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 11:
                error = new Errors.InvalidParamError('progress_callback');
              ...
              case 19:
                _error5 = new Errors.InvalidParamError('timeout');
              ...
              case 32:
                ...
                _error6 = new Errors.InvalidParamError('advancedOptions');
      ...
      if (this._isPlainObject(advancedOptions)) {
        if (Object.hasOwnProperty.call(advancedOptions, 'mode')) {
          if (/skip|kill|killnowait/.test(advancedOptions.mode)) {
            ...
            var _error7 = new Errors.InvalidParamError('mode');
        ...
        var _error8 = new Errors.InvalidParamError('advancedOptions');
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 17:
                _error9 = new Errors.InvalidParamError('invoke');
              ...
              case 22:
                ...
                _error10 = new Errors.InvalidParamError('advancedOptions');
              ...
              case 32:
                _error11 = new Errors.NoCallbackError();
              ...
              case 43:
                ...
                _error12 = new Errors.RPCAlreadyRegisteredError();

                this._fillOpStatusByError(_error12);
